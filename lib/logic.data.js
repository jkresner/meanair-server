...
class Projector {
  ...
  constructor(views, projections) {
    ...
    this.inflate = {}
    var smartMap = fn => function(input, ctx) {
    ...
    this.map = function(input, fn) { return smartMap(fn)(input, this) }
    this.md5 = str => str ? hash('md5').update(str, 'utf8').digest('hex') : null
    ...
    //-- For each view create default shorthands
    //-- =>   select[viewName](obj)
